      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Louis Lourens Van Der Bijl</h3>
          </div>
        </div>
        ...
        <div class="row text-center">
          ...
          <div class="col-md-6" id="personalD">
            <h4 class="introduction-heading">Personal information</h4>
              <p class="text-muted">
                <table class="center">
                  <tr>
                    <td><b>Name: </b></td><td><i> Louis Lourens</i></td>
                  </tr>
                  <tr>
                    <td><b>Surname: </b></td><td><i> Van Der Bijl</i></td>
                  </tr>
                  <tr>
                    <td><b>ID number: </b></td><td><i> 9409025019088</i></td>
                  </tr>
                  <tr>
                    <td><b>Age: </b></td><td><i> 26</i></td>
                  </tr>
                  <tr>
                    <td><b>Relationship: </b></td><td><i> Married</i></td>
                  </tr>
                  <tr>
                    <td><b>Health: </b></td><td><i> Excellent</i></td>
                  </tr>
                  <tr>
                    <td><b>Nationality: </b></td><td><i> South African</i></td>
                  </tr>
                  <tr>
                    <td><b>Address: </b></td><td><i> Witbank, Mpumalanga</i></td>
                  </tr>
                  </table><br><br>
                  <b><i>WILLING TO RELOCATE</i></b>
              </p>
          </div>
